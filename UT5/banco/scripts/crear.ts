...
var idCorrecto :boolean = true;
var numeroCorrecto :boolean = true;
function initCrear() {
        iniciar();
        insertarFecha();
...
function insertarFecha() :void{
        const fechaInput :HTMLInputElement = document.querySelector('#date');
        let n =  new Date();
        let y = n.getFullYear();
        let m = n.getMonth() + 1;
        let d = n.getDate();
...
function comprobarNumero() :void {
        let numeroCuenta :HTMLInputElement = document.querySelector('#numero');
        let pattern = new RegExp(/^ES\d{4}$/);
        const parrafo :HTMLParagraphElement = document.querySelector(`#numero-error`);
...
function comprobarId() :any {

    let idCliente :HTMLInputElement = document.querySelector('#id');
    let pattern = new RegExp(/^\d{4}[a-zA-z]{1}$/);
    const parrafo :HTMLParagraphElement = document.querySelector(`#id-error`);
...
function crearCuenta(event :Event){
    event.preventDefault();
    comprobarNumero();
    comprobarId();
    console.log(idCorrecto);
    console.log(numeroCorrecto);
    const numeroCuenta :HTMLInputElement = document.querySelector('#numero');
    const idTitular :HTMLInputElement = document.querySelector('#id');
