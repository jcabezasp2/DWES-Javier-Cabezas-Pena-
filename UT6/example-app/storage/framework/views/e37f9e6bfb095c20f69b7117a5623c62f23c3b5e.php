                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex justify-center">
                                <div class="rounded-lg shadow-lg bg-white max-w-sm">
                                    <a href="#!">
                                        <img class="w-100 rounded-t-lg" src="<?php echo e(asset('images/' . $project->image)); ?>"
                                            alt="" />
                                    </a>
                                    <div class="p-6">
                                        <h5 class="text-gray-900 text-xl font-medium mb-2"><?php echo e($project->name); ?></h5>
                                        <p class="text-gray-700 text-base mb-4">
                                            <?php echo e(Str::words($project->description, 20, ' ...')); ?>
...
<?php /**PATH /Users/javiercabezaspena/Library/Mobile Documents/com~apple~CloudDocs/DAW/Desarrollo servidor/UT6/example-app/resources/views/welcome.blade.php ENDPATH**/ ?>