                        ...
                        <table class="w-full text-sm lg:text-base" cellspacing="0">
                            <thead>
                                <tr class="h-12 uppercase">
                                    ...
                                    <th class="hidden text-right md:table-cell">Borrar</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr>
                                        <td class="hidden pb-4 md:table-cell">
                                            <a href="#">
                                                <img src="images/{{ $item->attributes->image }}" class="w-20 rounded"
                                                    alt="Thumbnail">
                                            </a>
                                        </td>
                                        <td>
                                            ...
                                            <div class="h-10 w-28">
                                                <div class="relative flex flex-row w-full h-8">
                                                    ...
                                                    <form action="{{ route('cart.update') }}" method="POST">
                                                        ...
                                                        <button
                                                            class="px-4 mt-1 py-1.5 text-sm rounded rounded shadow text-violet-100 bg-violet-500">Cambiar</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </td>
